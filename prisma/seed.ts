...
const tricklists: Tricklist[] = [
  {
    title: "Washington AM-Open 2022",
    year: 2022,
    eventNumber: 1,
    tricks: [
      "Juggle Spike",
  ...
  {
    title: "Hispanodama 2021",
    year: 2021,
    eventNumber: 1,
    tricks: [
      "1 TURN LH A DOBLE FLIP LH A DOWNSPIKE",
      "KENFLIP JUGGLE TOSS LH IN",
      "1 TURN LUNAR A DOBLE LUNAR A FASTHAND",
      "SARADO GRIP UNDERBIRD A FLIP OVER THE VALLEY A DOWNSPIKE",
      "AROUND USA",
      "FRONT GUNSLINGER A DOWNSPIKE FASTHAND",
      "HANDLESTALL A UFO",
      "LUNAR A LUNAR FLIP JUGGLE A TOSS LUNAR, FLIP IN",
      "DOBLE TAP A JUGGLE SPIKE",
      "1 TURN AIRPLANE A 1.5 SWAP SPIKE",
      "DOBLE WHIRLWIND",
      "1 TURN INSTA LH x2 A TRADE SPIKE",
      "HANDLESTALL A FLIP BIRD A FLIP OVER THE VALLEY, IN",
      "INWARD LUNAR A FLIP LUNAR COPA CHICO A MEDIO FLIP OVER SPIKE A INWARD LUNAR A FALL IN",
      "PULL UP KENFLIP A DOBLE KENFLIP A LH, FLIP TRADE SPIKE",
      "DOBLE J-STICK",
      "INWARD LUNAR A FLIP CUSHION, FLIP IN",
      "SWEETS SPECIAL",
      "1 TURN LH A INSTA STUNTPLANE",
      "BORDER BALANCE 3SEG",
      "AIRPLANE FASTHAND A FLIP OUT FASTHAND",
      "2 TURN LUNAR A ROVER 180, FLIP IN",
      "STILT A STILT OVER THE VALLEY, IN",
      "AROUND JUGGLE",
      "STILT A STILT FLIP, A FLIP IN",
    ],
  },
  {
    title: "NAKO 2021 (Beginner)",
    year: 2021,
    eventNumber: 1,
    tricks: [
      "Big cup Orbit, Spike",
  ...
  {
    title: "Sweets Throwback Throwdown (Beginner)",
    year: 2021,
    eventNumber: 1,
    tricks: [
      "Frying pan",
  ...
  {
    title: "Sweets Throwback Throwdown (Intermediate)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "Sweets Throwback Throwdown (Open)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "Oceanside Kendama Open (Beginner)",
    year: 2021,
    eventNumber: 1,
    tricks: [
      "Around the block",
  ...
  {
    title: "Oceanside Kendama Open (Intermediate)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "Oceanside Kendama Open (Open)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "Oceanside Kendama Open (Top 8 Open)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "Sakura Summer 2021 (Beginner)",
    year: 2021,
    eventNumber: 1,
    tricks: [
      "Swing Candle Stick",
  ...
  {
    title: "Sakura Summer 2021 (Intermediate)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "SKO No Pro Open 2021 (Beginner)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "SKO No Pro Open 2021 (Intermediate)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "SKO No Pro Open 2021 (Advanced)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "SKO No Pro Open 2021 (Open)",
    year: 2021,
    eventNumber: 1,
    tricks: [
  ...
  {
    title: "SKO No Pro Open 2021 (Top 16 Open)",
    year: 2021,
    eventNumber: 1,
    tricks: [
...
const main = async () => {
  for (const tricklist of tricklists) {
    const { title, year, eventNumber, tricks } = tricklist;
    let tricksOfList: Trick[] = [];
    for (const trick of tricks) {
      tricksOfList.push({ title: trick });
    }
    await prisma.tricklist.create({
      data: {
        title,
        year,
        eventNumber,
